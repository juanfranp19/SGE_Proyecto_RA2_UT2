...
![Contacto de Odoo](../assets/img/06-contactos/paso02_odoo-contacto.png)

3. En "**Etiquetas**", si escribimos una, y le damos a crear, estaremos creando una y a la vez **asignándosela al contacto**.

![Agregar etiqueta](../assets/img/06-contactos/paso03_agregar-etiqueta.png)

O, desde **configuración**, entramos en "**Etiquetas de contacto**"

![Agregar etiqueta](../assets/img/06-contactos/paso03_agregar-etiqueta2.png)
...
![Agregar etiqueta](../assets/img/06-contactos/paso03_agregar-etiqueta3.png)

4. También podemos **filtrar**: por **personas, compañías**, etc. En el ejemplo de la imagen se filtra por **etiquetas**.

![Filtrar por etiqueta](../assets/img/06-contactos/paso04_filtrar-por-etiquetas.png)
...
![Acciones](../assets/img/06-contactos/paso05_acciones.png)
...
![Programar actividad](../assets/img/06-contactos/paso06_programar-actividad.png)
...
![Seguir contacto](../assets/img/06-contactos/paso07_seguir.png)

8. Para importar contactos, es necesario entrar a esta página desde la la opción **Importar registros** del icono de tuerca.

![Opciones](../assets/img/06-contactos/paso08_opciones.png)

![Programar actividad](../assets/img/06-contactos/paso08_pag-importar.png)
...
![Plantilla](../assets/img/06-contactos/paso09_plantilla.png)
...
![Importar archivo](../assets/img/06-contactos/paso10_archivo-importacion.png)
...
![Contactos importados](../assets/img/06-contactos/paso11_contactos-importados.png)

12. Para que los usuarios tengan **acceso al portal**, es decir, para que puedan descargarse sus facturas, agilice documentación...

![Acceso portal](../assets/img/06-contactos/paso12_acceso-portal.png)
...
![Otorgar acceso](../assets/img/06-contactos/paso13_otorgar-acceso.png)

![Acceso otorgado](../assets/img/06-contactos/paso13_acceso-otorgado.png)
